...
the idea was to integrate the JIRA REST api to get tasks with more info. The Slack JIRA integration was a little s _lacking_ ha. But we ended up using the bot for general pupose fun and a few tasks that I left out for reasons. Life caught up and I wanted to bike more. So I stopped working on this. 
